...
use uniJuegos\Bundle\Entity\noticias;
use uniJuegos\Bundle\Form\noticiasType;
...
class noticiasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniJuegosBundle:noticias')->findAll();

        return $this->render('uniJuegosBundle:noticias:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniJuegosBundle:noticias:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniJuegosBundle:noticias')->find($id);
        ...
        return $this->render('uniJuegosBundle:noticias:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniJuegosBundle:noticias:edit.html.twig', array(
            'entity'      => $entity,
