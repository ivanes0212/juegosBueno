...
use uniJuegos\Bundle\Entity\categorias;
use uniJuegos\Bundle\Form\categoriasType;
...
class categoriasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('uniJuegosBundle:categorias:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniJuegosBundle:categorias:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniJuegosBundle:categorias')->find($id);
        ...
        return $this->render('uniJuegosBundle:categorias:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniJuegosBundle:categorias:edit.html.twig', array(
            'entity'      => $entity,
